...
import { expectCliToCreateRc, expectOutputRcInStdout } from '../../../../cli/tests/jest/expect';
import { expectNoPromptsOfInitInStdout, expectPromptsOfInitInStdout } from '../../../../cli/tests/jest/expect.init';
