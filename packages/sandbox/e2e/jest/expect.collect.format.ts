...
export function expectCollectCommandCreatesHtmlReport(
  ...
  const reportHTML = prj.readOutput(userFlowName, rcName, 'html')[0].content;
...
export function expectCollectCommandCreatesJsonReport(
  ...
  const reportJson = prj.readOutput(reportName, rcName, 'json')[0].content as any;
...
export function expectCollectCommandCreatesMdReport(
  ...
  const reportMd = prj.readOutput(reportName, rcName, 'md')[0].content;
