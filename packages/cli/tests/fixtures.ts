...
export const USER_FLOW_RC_CUSTOM_JSON_NAME = ".user-flowrc.custom.json";
...
export const SETUP_SANDBOX_CUSTOM_RC = path.join(SETUP_SANDBOX_PATH, USER_FLOW_RC_CUSTOM_JSON_NAME);
