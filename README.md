...
In this chapter we will learn how to install and configure user flows, as well as create a first example test and see
...
You can read more about tricks and DX
the [general CLI features](https://github.com/push-based/user-flow/blob/main/packages/cli/docs/general-cli-features.md)
in our docs.
...
official [user-flow/lighthouse configuration](https://github.com/GoogleChrome/lighthouse/blob/master/docs/configuration.md).

Details on how to work with configurations can be found in
the [configuratin section](./packages/cli/docs/lh-configuraton.md).
...
See [performance-budgets](https://github.com/push-based/user-flow/blob/main/packages/cli/docs/performance-budgets.md)
for more details.
